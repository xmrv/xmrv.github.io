...
export default function Kahvalti() {
  ...
  const [dataSets, setDataSets] = useState([]); // Her tablo için sheet verisi
  ...
  async function loadTables() {
    ...
    const ref = collection(db, "menus", "kahvalti", "tables");
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold mb-4">Kahvaltı Menüsü</h2>
